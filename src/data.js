...
const getIdByAirline = (name) => {
  return airlines.find(airline => airline.name === name).id;
};

const getCodeByAirport = (name) => {
...
const getLocationByCode = (code) => {
  ...
  return {x: airport.long, y: airport.lat};
};

export default {routes, airlines, airports, getAirlineById, getAirportByCode, getIdByAirline, getCodeByAirport, getLocationByCode};